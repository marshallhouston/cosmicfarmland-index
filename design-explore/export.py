...
USED = ["specimen-ice-plant", "specimen-bee-balm", "specimen-aster",
        ...
        # the eleventh plate came out of the unused library. it held a generic
        # bleached grass stalk until the plant prints page made every specimen
        # answer for itself, and that one answered for nothing in the yard.
        # blue grama takes it: a real grass from the mosaic bed, and still not
        # a flowering stem, which is what the critiques kept asking for.
        # the garden-in-a-box plants that had no plate yet, generated by gen3.py
        "specimen-autumn-joy-sedum",
        "specimen-red-salvia",
        "specimen-moonbeam-coreopsis",
        "specimen-prairie-winecups",
        "specimen-black-eyed-susan",
        "specimen-butterfly-blue-pincushion",
        "specimen-blue-spruce-sedum",
        "specimen-blue-grama-grass",
        "specimen-blue-flax",
        "specimen-prairie-coneflower",
        "specimen-rabbitbrush",
        "specimen-rigid-goldenrod",
        "specimen-rocky-mountain-penstemon",
        "specimen-showy-fleabane",
        "specimen-yellow-columbine",
        "specimen-walkers-low-catmint",
        "specimen-blanket-flower",
        "specimen-golden-baby-goldenrod",
        "specimen-pineleaf-penstemon",
        "specimen-rose-marvel-salvia",
        "specimen-basket-of-gold",]
